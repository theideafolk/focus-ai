...
export default function ProjectCard({ project, preferredCurrency = 'USD' }: ProjectCardProps) {
  ...
  return (
    <div
      ...
      className="block bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-4 border border-gray-100 cursor-pointer"
    >
      ...
      <div className="mt-3 space-y-2">
        ...
        {project.complexity && (
          <div className="flex items-center text-xs">
            <BarChart2 className="w-3.5 h-3.5 mr-1 text-gray-500" />
            ...
            {project.is_recurring && (
              <span className="ml-2 px-1.5 py-0.5 rounded-full bg-blue-100 text-blue-800">
                Recurring
              </span>
            )}
          </div>
